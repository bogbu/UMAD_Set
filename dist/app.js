...
function gcDebuffButtonClasses(rowConfig){if(rowConfig.mechanic!=='debuff2')return null;const paired=pairedGcDebuffChoice(state.custom.debuff1);return paired!==MechanicState.Unset?{[paired]:'suggested'}:null}
